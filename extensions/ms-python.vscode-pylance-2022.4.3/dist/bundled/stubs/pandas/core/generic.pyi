...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def convert_dtypes(self:FrameOrSeries, infer_objects: _bool = ..., convert_string: _bool = ..., convert_integer: _bool = ..., convert_boolean: _bool = ..., convert_floating: _bool = ... ) -> FrameOrSeries: ...
